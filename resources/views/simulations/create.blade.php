            ...
            <div class="mdl-cell mdl-cell--12-col" style="margin-left: 20px; margin-right: 20px; margin-top: 40px;">
                <div class="mdl-card mdl-card--border mdl-shadow--2dp" style="width: 100%">
                    <div style="padding-top: 30px;">
                        <form action="{{ route('simulations.store') }}" method="POST" style="text-align: center" id="form-users">
                            {{ csrf_field() }}
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" required name="title" type="text" id="input_name">
                                <label class="mdl-textfield__label" for="input_name">Simulation Name</label>
                            </div>
                            <br>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" required name="description" type="text" id="input_email">
                                <label class="mdl-textfield__label" for="input_email">Description</label>
                            </div>
                            <br>
                            <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                                <input class="mdl-textfield__input" required value="1" name="image" type="text" id="input_password">
